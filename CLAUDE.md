...
the permissions boundary `arn:aws:iam::043755383885:policy/hackathon-boundary`.
...
- SAM template (preferred - covers every function's generated role):
  ...
  Globals:
    Function:
      PermissionsBoundary: arn:aws:iam::043755383885:policy/hackathon-boundary
  ```
...
aws iam create-role \
  ...
  --permissions-boundary arn:aws:iam::043755383885:policy/hackathon-boundary \
...
aws lambda create-function --function-name my-function ... \
  --role arn:aws:iam::043755383885:role/my-app-role
```
